// 2D Scrolling from: https://dartpad.dev/?id=4424936c57ed13093eb389123383e894
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TwoDimensionsScrollingExample(),
    );
  }
}

class TwoDimensionsScrollingExample extends StatelessWidget {
  const TwoDimensionsScrollingExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('2D Scrolling')),
